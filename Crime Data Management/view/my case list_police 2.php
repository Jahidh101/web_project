...
<body>
    ...
    if (isset($_SESSION['id'])) {
        ...
        echo '<h2 class="h2">My Case List</h2>';
    }
    ?>
    ...
    <tbody>
        ...
        foreach ($myCaseList as $i => $case):
            echo '<tr>';
                ...
                echo '<td><a href="ADD EXTERNAL POLICE.php?CaseNumber=' .$case["CaseNumber"]. '"><button>Add External Police</button></a> &nbsp<a href="EDIT A CASE.php?CaseNumber=' .$case["CaseNumber"]. '"><button>Edit case</button></a> &nbsp<a href="DELETE A CASE.php?CaseNumber=' .$case["CaseNumber"]. '"><button>Delete case</button></a></td>';
